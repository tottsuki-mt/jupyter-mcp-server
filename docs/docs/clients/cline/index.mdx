...
To use Jupyter MCP Server with Cline, add the [Jupyter MCP Server configuration](/run) to your `.cline_mcp_settings.json` file, read more on the [Cline documentation](https://marketplace.visualstudio.com/items?itemName=saoudrizwan.claude-dev).
