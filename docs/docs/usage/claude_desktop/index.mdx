...
To use Jupyter MCP Server with Claude Desktop, add the [Jupyter MCP server configuration](../../usage#configuration) to your `claude_desktop_config.json` file (read more on the [MCP documentation website](https://modelcontextprotocol.io/quickstart/user#2-add-the-filesystem-mcp-server)).

**📺 Watch the setup demo**
<iframe width="560" height="315" src="https://www.youtube.com/embed/nPllCQxtaxQ"
