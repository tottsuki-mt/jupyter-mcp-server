...
To use Jupyter MCP Server with Cline, add the [Jupyter MCP server configuration](../../usage#configuration) to your `.cline_mcp_settings.json` file (read more on the [Cline documentation](https://marketplace.visualstudio.com/items?itemName=saoudrizwan.claude-dev)).
